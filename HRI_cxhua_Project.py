...
class Pepper:
    ...
    def experiment(self):
        ...
        # - move to table
        self.ask("Please set up the cup and fork on the table. Press 'Ok' when you are finished.")
        # question 4
        self.ask("Please throw the letters into the bin beside the table. Press 'Ok' when you are finished.")
        # question 5
        ...
        # - move back to sofa
        # question 7
        self.ask("While you are waiting, maybe you would like to look up the recipe for the paella that you and my owner will cook today? You can use the laptop on the table. Press 'Ok'.")
        # question 8
